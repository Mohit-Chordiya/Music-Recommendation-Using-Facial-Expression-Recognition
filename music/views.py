...
def spotifyApi(request):
    ...
    elif re.my_emotion == "Fearful":
        playlist = spotify.playlist_items('5fqvsIAHdcka1upUQzaxWT')

    elif re.my_emotion == "Surprised":
        playlist = spotify.playlist_items('4o5SxWNsTNLOi9ahHeJF8A')
